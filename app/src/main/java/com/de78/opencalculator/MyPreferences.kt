...
class MyPreferences(context: Context) {
    ...
    companion object {
        private const val THEME = "de78.opencalculator.THEME"
        private const val FORCE_DAY_NIGHT = "de78.opencalculator.FORCE_DAY_NIGHT"

        private const val KEY_VIBRATION_STATUS = "de78.opencalculator.KEY_VIBRATION_STATUS"
        private const val KEY_HISTORY = "de78.opencalculator.HISTORY_ELEMENTS"
        private const val KEY_PREVENT_PHONE_FROM_SLEEPING = "de78.opencalculator.PREVENT_PHONE_FROM_SLEEPING"
        private const val KEY_HISTORY_SIZE = "de78.opencalculator.HISTORY_SIZE"
        private const val KEY_SCIENTIFIC_MODE_ENABLED_BY_DEFAULT = "de78.opencalculator.SCIENTIFIC_MODE_ENABLED_BY_DEFAULT"
        private const val KEY_RADIANS_INSTEAD_OF_DEGREES_BY_DEFAULT = "de78.opencalculator.RADIANS_INSTEAD_OF_DEGREES_BY_DEFAULT"
        private const val KEY_NUMBER_PRECISION = "de78.opencalculator.NUMBER_PRECISION"
        private const val KEY_WRITE_NUMBER_INTO_SCIENTIC_NOTATION = "de78.opencalculator.WRITE_NUMBER_INTO_SCIENTIC_NOTATION"
        private const val KEY_LONG_CLICK_TO_COPY_VALUE = "de78.opencalculator.LONG_CLICK_TO_COPY_VALUE"
        private const val KEY_ADD_MODULO_BUTTON = "de78.opencalculator.ADD_MODULO_BUTTON"
        private const val KEY_SPLIT_PARENTHESIS_BUTTON = "de78.opencalculator.SPLIT_PARENTHESIS_BUTTON"
        private const val KEY_DELETE_HISTORY_ON_SWIPE = "de78.opencalculator.DELETE_HISTORY_ELEMENT_ON_SWIPE"
        private const val KEY_AUTO_SAVE_CALCULATION_WITHOUT_EQUAL_BUTTON = "de78.opencalculator.AUTO_SAVE_CALCULATION_WITHOUT_EQUAL_BUTTON"
    }
